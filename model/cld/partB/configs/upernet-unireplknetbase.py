...
test_cfg = None
train_cfg = dict(
    max_iters=756800, type='IterBasedTrainLoop', val_interval=7115)
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=
        'dataset/Mmseg_Clds21SegmentationPartB',
        img_suffix='',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
work_dir = 'model/cld/partB/weights/upernet-unireplknetbase'
