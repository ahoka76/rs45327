...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/home/kari_kjle/.cache/torch/hub/checkpoints/unireplknet_b_in22k_pretrain.pth',
            type='Pretrained'),
        kernel_sizes=None,
...
resume = False
test_cfg = None
train_cfg = dict(max_iters=89840, type='IterBasedTrainLoop', val_interval=1123)
...
work_dir = 'model/oem/holdout/weights/upernet-unireplknetbase'
